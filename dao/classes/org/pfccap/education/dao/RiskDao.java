 ...
 * DAO for table "RISK".
*/
public class RiskDao extends AbstractDao<Risk, Long> {

    public static final String TABLENAME = "RISK";

    /**
     * Properties of entity Risk.<br/>
    ...
    */
    ...
    public RiskDao(DaoConfig config) {
        super(config);
    }
    
    public RiskDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"RISK\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"RISK\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Risk entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public Risk readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Risk entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Risk entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Risk entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
